...
- **ชุดข้อมูลดิบที่ทดสอบ (Raw Dataset):** `heart.csv`
- **ขนาดข้อมูลดิบ (Raw Dimensions):** `918 แถว × 12 คอลัมน์`
- **คอลัมน์เป้าหมายในการทำนาย (Target Column):** `HeartDisease`
- **ประเภทงาน (Task Type):** `CLASSIFICATION`
- **Session ID ดำเนินการอ้างอิง:** `19da1342`
...
| :------------------------------------------------ | :----------------------------- | :----------------------------------------------------------------------------------------------------------------------- |
| **การเลือกฟีเจอร์ (Feature Selection)**           | ทำโดยอัตโนมัติภายใน AutoGluon  | ไม่ตัด feature ออก (เก็บทุกคอลัมน์)                                                                                      |
...
| **การแปลงข้อมูลและปรับขนาด (Encoding & Scaling)** | แปลงอัตโนมัติภายในระบบ         | แปลงตามผู้ใช้ยืนยัน: **Label Encoding** บน 2 คอลัมน์, **One-Hot Encoding** บน 3 คอลัมน์ และปรับขนาดโดย **MinMax Scaler** |
...
| :------------------------- | :--------------------: | :---------------------------------: | :---------: |
| **Accuracy**               |         0.9022         |               0.8913                |   -0.0109   |
| **Precision(Mac)**         |         0.9032         |               0.8900                |   -0.0132   |
| **Recall(Mac)**            |         0.8986         |               0.8900                |   -0.0086   |
| **F1(Mac)**                |         0.9005         |               0.8900                |   -0.0105   |
...
| :-------------------------------- | :--------------------: | :---------------------------------: |
| **โมเดลที่ดีที่สุด (Best Model)** | `XGBoost_BAG_L2_FULL`  |             `CatBoost`              |
| **เวลาในการเทรน (Training Time)** |    `520.76 วินาที`     |           `17.07 วินาที`            |
...
_รายงานฉบับนี้สร้างโดยระบบสคริปต์เปรียบเทียบอัตโนมัติเปรียบเทียบเคียงข้างกันเสร็จสมบูรณ์เมื่อวันที่ 21/05/2026 13:39:06_
