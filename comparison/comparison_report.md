...
* **ชุดข้อมูลดิบที่ทดสอบ (Raw Dataset):** `Automobile.csv`
* **ขนาดข้อมูลดิบ (Raw Dimensions):** `205 แถว × 26 คอลัมน์`
* **คอลัมน์เป้าหมายในการทำนาย (Target Column):** `fuel-type`
* **ประเภทงาน (Task Type):** `CLASSIFICATION`
* **Session ID ดำเนินการอ้างอิง:** `54511dc8`
...
| :--- | :---: | :---: | :---: |
| **Accuracy** | 1.0000 | 0.9756 | -0.0244 |
| **Precision(Mac)** | 1.0000 | 0.9868 | -0.0132 |
| **Recall(Mac)** | 1.0000 | 0.8750 | -0.1250 |
| **F1(Mac)** | 1.0000 | 0.9219 | -0.0781 |
...
| :--- | :---: | :---: |
| **โมเดลที่ดีที่สุด (Best Model)** | `WeightedEnsemble_L2` | `Gradient Boosting` |
| **เวลาในการเทรน (Training Time)** | `20.31 วินาที` | `17.05 วินาที` |
...
---
*รายงานฉบับนี้สร้างโดยระบบสคริปต์เปรียบเทียบอัตโนมัติเปรียบเทียบเคียงข้างกันเสร็จสมบูรณ์เมื่อวันที่ 21/05/2026 01:04:09*
